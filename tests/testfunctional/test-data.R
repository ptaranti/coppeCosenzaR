...
Coppe.cosenza(project.portfolio, option.portfolio, factors.of.interest, "default", FALSE)



message("\n\n Testing: Coppe.cosenza(p1, option.portfolio, factors.of.interest)")
Coppe.cosenza(p1, option.portfolio, factors.of.interest, "default", FALSE)


message("\n\n Testing: Coppe.cosenza(project.portfolio, o1, factors.of.interest)")
Coppe.cosenza(project.portfolio, o1, factors.of.interest, "default", FALSE)
